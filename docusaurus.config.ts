...
const config: Config = {
  ...
  projectName: "noc-docs", // Usually your repo name.
    ...
    [
      "classic",
      {
        docs: {
          ...
          editUrl:
            "https://github.com/girasolximena/noc-docs/tree/main/packages/create-docusaurus/templates/shared/",
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: "https://github.com/girasolximena/noc-docs",
          label: "GitHub",
          position: "right",
        },
      ],
